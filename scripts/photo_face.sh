...
echo "=========================================="
echo "       PHOTO FACE ENHANCE"
echo "=========================================="
echo
echo "Файл:      $INPUT"
echo "Upscale:   ${UPSCALE}x"
...
RESPONSE=$(curl -s -X POST \
    "http://127.0.0.1:8000/api/photo/face-enhance?upscale=$UPSCALE&fidelity=$FIDELITY" \
    -F "file=@$INPUT")
